...
\begin{itemize}
	...
	\item Apache
		...
		El servidor HTTP Apache \cite{apache} es un servidor web HTTP de código abierto, multiplataforma, extensible y modular. Además, al ser tan popular tiene un gran soporte de la comunidad.
